...
namespace FootballSchool.Pages
{
    public class BranchesModel : PageModel
    {
        ...
        public class BranchDto
        {
            ...
            // Свойство для отображения картинки из байтов БД
        ...
        public async Task OnGetAsync()
        {
            ...
            foreach (var b in branchesFromDb)
            {
                ...
                Branches.Add(new BranchDto
                {
                    ...
                    House = b.HouseBranch,
                    Phone = b.PhoneBranch,
                    // Конвертируем байты из БД в строку для HTML
                    ...
                    MainCoachName = mainCoach != null ? $"{mainCoach.SurnameCoach} {mainCoach.NameCoach}" : "Не назначен",
        ...
        public async Task<IActionResult> OnPostSaveBranchAsync()
        {
            try
            {
                ...
                if (ModalBranch.BranchId == 0)
                {
                    var newBranch = new Branch
                    {
                        ...
                        PhotoBranch = imageData // Сохраняем байты в БД
                    };
                    _context.Branches.Add(newBranch);
                    TempData["SuccessMessage"] = "Новый филиал добавлен в базу!";
                }
                else
                {
                    ...
                    if (existing != null)
                    {
                        ...
                        TempData["SuccessMessage"] = "Данные в БД обновлены!";
                    }
                }
            ...
            {
                TempData["ErrorMessage"] = "Ошибка БД: " + ex.Message;
            }
        ...
        public async Task<IActionResult> OnPostDeleteBranchAsync(int id)
        {
            ...
            if (branch != null)
            {
                ...
                await _context.SaveChangesAsync();
                TempData["SuccessMessage"] = "Филиал удален из базы данных!";
            }
            return RedirectToPage();
        }

        // Логика залов остается прежней
